...
library(xlsx)
eb <- read.xlsx("./dados/estatistica_basica.xlsx",encoding =  "UTF-8", sheetName = "Plan1")
head(eb)
...
# Histograma
eh <- read.xlsx("./dados/estatistica_basica.xlsx", sheetName = "Plan2")
head(eh)
#  eixos
#1   4.8
#2   4.9
...
# Gráfico Pizza
ep <- read.xlsx("./dados/estatistica_basica.xlsx",encoding = "UTF-8", sheetName = "Plan3")
head(ep)
#                  ccusto defeitos
#1           Pré-usinagem        9
...
# Média
ma <- read.xlsx("./dados/estatistica_basica.xlsx", sheetName = "Plan4")
head(ma)
#  dados
#1   4.5
#2   4.6
...
# Mediana
md <- read.xlsx("./dados/estatistica_basica.xlsx", sheetName = "Plan5")
head(md)
#  dados
#1    65
#2    72
...
# Moda
moda <- read.xlsx("./dados/estatistica_basica.xlsx", sheetName = "Plan5")
head(moda)
# Create the function
...
# [1] 9.224055
# Amplitude
ampl <- read.xlsx("./dados/estatistica_basica.xlsx", sheetName = "Plan5")
head(ampl)
range(ampl)
diff( range(ampl) )

# Quartis
quartil <- read.xlsx("./dados/estatistica_basica.xlsx", sheetName = "Plan6")
head(quartil)
